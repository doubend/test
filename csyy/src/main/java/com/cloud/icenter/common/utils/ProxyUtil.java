...
public class ProxyUtil {
	...
	public static String proxyHost = "77.85.203.203";
	public static int proxyPort = 37557;
	 ...
	 * @return
	 */
	public static JsonResult httpRequest(String req_url) {
		...
		return new JsonResult(200,buffer.toString());
	}
	...
	public static void main(String[] args) {
		...
		// demo:代理访问
		String url = "http://news.sohu.com/20151223/n432284385.shtml";
		String para = "";
		JsonResult sr = ProxyUtil.httpRequest(url);
