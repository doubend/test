...
public class ZipUtil {
	 ...
	 * @throws Exception 
	 */
	public static void zip(String srcPath, OutputStream out) throws Exception{
		if (StringUtils.isEmpty(srcPath) || out == null) {
			throw new Exception("Parameters is null");
		}
		CheckedOutputStream cos = null;
		ZipOutputStream zos = null;
   ...
   public static String gunzip(String compressedStr) {
       if (compressedStr == null||compressedStr.length()<1) {
           return null;
       }
   ...
   public static String gzip(String primStr) {
	...
	public static void main(String[] args) {
		...
		String zipFilePath = "D:\\ziptest\\zipPath\\apache-ant-1.9.7-bin.zip";
