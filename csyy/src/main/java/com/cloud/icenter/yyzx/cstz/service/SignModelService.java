...
*/
public interface SignModelService extends BaseService<SignModel> {
	 ...
	 * @return
	 */
	public List<CstzCommonPojo> getOptimalTop(List<CstzCommonPojo> lstSig, int topNum);
...
//	public List<Double> getLstzByNameAndYear(String tzmc, int nf);
	...
	/**
	 * 综合体征一级页面指标排行数据获取 zhucy 20170615新增
