...
*/
@Entity
@Table(name = "t_whly_hy_sr")
public class IndustryIncome  extends Pojo {
	@Id
	 ...
	 * 行业类别代码
	 */
	@Column(name = "hylbdm", length = 10)
    private  int hylbdm;  
    
	/**
	 * 行业类别名称
	 */
	@Column(name = "hybmc", length = 32)
    ...
    public void setHylbdm (int hylbdm){
        this.hylbdm = hylbdm;
    }
    public int getHylbdm (){
        return this.hylbdm;
    }
