...
industrialOption = {
    ...
    title : {
        ...
        subtext:'',
        x:'center',
		y:setObj.industrialOptionTitleY,
		itemGap: 10,
		textAlign: 'center',
		textStyle : {
			color: '#2ab6ff',
...
var data2014 = '[{"nian":"2011","one":1432.19,"two":434.69,"third":128.82},{"nian":"2012","one":1500.94,"two":364.44,"third":80.48},{"nian":"2013","one":1650.76,"two":414.70,"third":84.09},{"nian":"2014","one":1738.40,"two":448.78,"third":80.63},{"nian":"2015","one":1775.87,"two":496.71,"third":93.18}]';
/**
var data2014 = '[{"nian":"2011","one":1432.19,"two":434.69,"third":128.82,"four":98.47},{"nian":"2012","one":1500.94,"two":364.44,"third":80.48,"four":55.25},{"nian":"2013","one":1650.76,"two":414.70,"third":84.09,"four":54.92},{"nian":"2014","one":1738.40,"two":448.78,"third":80.63,"four":50.41},{"nian":"2015","one":1775.87,"two":496.71,"third":93.18,"four":63.23}]';
**/
$.each(JSON.parse(data2014),function(i,value){
	nian.push(value.nian);
	one.push(value.one);
	two.push(value.two);
	third.push(value.third);
	/**
	four.push(value.four); 
	**/
});
...
microCompanyOption = {
	    ...
	    tooltip : {
	        trigger: 'axis',
			formatter: "{b}年 <br/>{a} : {c}<br/>{a1} : {c1}"
	    },
	    legend: {
			y: 'bottom',
			textStyle: {color: '#FFF'},
	        /** data:['工业利税','工业利润','主营业务收入','高新技术产业产值'] **/
	        data:['工业利税','主营业务收入','高新技术产业产值']
	    },
	    xAxis : [
	        {
	            type : 'category',
...
var obj = {};
obj.xssr = (parseFloat(objTemp.XSSR)/ 100000000).toFixed(0);
obj.sjse = (parseFloat(objTemp.SJSE)/ 100000000).toFixed(0);
obj.sbjn = (parseFloat(objTemp.sbjn)/ 100000000).toFixed(0);
