    ...
    series : [
        {
            ...
            axisLine: {            // 坐标轴线
                ...
                lineStyle: {       // 属性lineStyle控制线条样式
                	color: [[0.2, '#ff0066'],[0.5, '#ff8a00'],[0.8, '#00b050'],[1, '#1e82c8']],
                    width: 20
                }
            },
            axisTick: {            // 坐标轴小标记
            ...
            data:[{value: 9.0, name: '完成率'}]
        }
    ]
};

EchartsBox01_option2 = {
	    tooltip : {
	        show:false
	    },
	    series : [
...
//     EchartsBox01_option.series[0].data[0].value = (Math.random()*100).toFixed(2) - 0;
//     EchartsBox01.setOption(EchartsBox01_option,true);
// },2000);
