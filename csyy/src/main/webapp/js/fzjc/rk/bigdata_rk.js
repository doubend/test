	...
	$.post(contextPath+"/dp/getDtsj",{"type":'0'},function(da){
		if(da.data!=null){
			...
			for(var i=0;i<datalist.length;i++){
				...
				if(i<5){
					lrtop5Str += "<dl class='cont-item col-20'> <dt>"+datalist[i].outmigrate+"</dt><dd><span class='num'><em>"+datalist[i].number+"</em><i>万</i></span></dd></dl>";
				}
				if(i>4 && i<10){
					lrtop10Str += "<dl class='cont-item col-20'> <dt>"+datalist[i].outmigrate+"</dt><dd><span class='num'><em>"+datalist[i].number+"</em><i>万</i></span></dd></dl>";
				}
			}
			var topdataHtml = document.getElementById("data21").innerHTML.toString();
			var newStr = topdataHtml.replace("@data21",lrnumber);
	...
	$.post(contextPath+"/dp/getDtsj",{"type":'1'},function(da){
		if(da.data!=null){
			...
			for(var i=0;i<datalist.length;i++){
				...
				if(i<5){
					lctop5Str += "<dl class='cont-item col-20'> <dt>"+datalist[i].immigration+"</dt><dd><span class='num'><em>"+datalist[i].number+"</em><i>万</i></span></dd></dl>";
				}
				if(i>4 && i<10){
					lctop10Str += "<dl class='cont-item col-20'> <dt>"+datalist[i].immigration+"</dt><dd><span class='num'><em>"+datalist[i].number+"</em><i>万</i></span></dd></dl>";
				}
			}
			var topdataHtml = document.getElementById("data22").innerHTML.toString();
			var newStr = topdataHtml.replace("@data22",lcnumber);
...
function rkldtop(type){
	if(type=='1'){
		document.getElementById("toptitle").innerHTML = "<div class='flow-destination fd-out'>流入目的地<br>TOP10</div>";
		document.getElementById("top5").innerHTML = lctop5Str;
		document.getElementById("top10").innerHTML = lctop10Str;
	}
	if(type=='0'){
		document.getElementById("toptitle").innerHTML = "<div class='flow-destination fd-in'>人口流出地<br>TOP10</div>";
...
function rkld(type){
	...
	$.post(contextPath+"/dp/getDtsj",{"type":type},function(da){
		...
		if(da.data!=null){
			...
			loadLdrkMap(markLineArray,datasArray,markPointArray);
		}else{
			alert("人口流动地图数据异常");
		}
...
function loadLdrkMap(markLineArray,datasArray,markPointArray){
	var mapOption = {
	...
	$.post(contextPath+"/dp/getPdistributionByYear","",function(da){
		if(da.data!=null){
			...
			for(var i=0;i<datalist.length;i++){
				...
				var tempdata = city+","+number+","+scale+","+nvb;
			...
			if(off1==0){
				...
				$("#male1-3").html("<div class='pi-left'>"+da1_man+"万</div><div class='pi-right'>"+da1_wom+"万</div>");
				//15~64男人占比
				...
				$("#male2-3").html("<div class='pi-left'>"+da2_man+"万</div><div class='pi-right'>"+da2_wom+"万</div>");
				//65+
				...
				$("#male3-3").html("<div class='pi-left'>"+da3_man+"万</div><div class='pi-right'>"+da3_wom+"万</div>");
				off1 = 1;
			}
...
function loaddatas(data1,data2,data3){
	document.getElementById("wd1").innerHTML = "<em>"+data1+"</em><i>万</i>";
	document.getElementById("wd2").innerHTML = "<em>"+data2+"</em><i>万</i>";
	document.getElementById("wd3").innerHTML = "<em>"+data3+"</em><i>万</i>";
}
