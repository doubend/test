...
<body>
        ...
        <div class="col-md-12">
          <div class="caption clearfix">
            <div class="col-md-12 pdl-0">
              <div class="col-md-5">
                <!-- <a id="btnAdd" href="javascript:;" onclick="cstz.tzmxTree.openAdd()" style="display: none;" class="btn green" data-toggle="tooltip" data-placement="top" title="为当前所选择的体征添加下级体征"> <i
                class="icon-plus"></i> <span> 添加体征</span>
                </a>  -->
                <a id="btnEdit" href="javascript:;" style="display: none;" onclick="cstz.tzmxTree.openUpdate()" style="display: none;" class="btn green" data-toggle="tooltip" data-placement="top" title="为当前所选择的体征添加下级体征"> <i
                class="fa fa-edit"></i> <span> 修改体征</span>
                </a> 
               <!--  <a id="btnDel" href="javascript:;" onclick="cstz.tzmxTree.remove()"
                  class="btn btn-danger" style="display: none;" data-toggle="tooltip" data-placement="top" title="删除选中的体征信息"> <i class="icon-close"></i> <span>
                    删除体征 </span>
                </a> -->
              <!--   <a id="btnDel" href="javascript:;" style="display: none;" onclick="cstz.tzmxTree.save()"
                  class="btn btn-danger" style="display: none;" data-toggle="tooltip" data-placement="top" title="保存改变的数据"> <i class="icon-save"></i> <span>
                    保存权重 </span>
                </a> -->
              </div>
            </div>
          </div>
          <div class="DB-style pdt-10" style="height: 430px;">
 ...
 <script data-main="${contextPath}/js/cstz/tzmxTree" src="${contextPath}/js/assets/require.js"></script>
</body>
</html>
