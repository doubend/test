...
<body>
<!-- <iframe frameborder="0" height="704" width="1216" scrolling="auto"> -->
	
<a class="index-dp" href="${contextPath}/big_nync/dp_navigation" target='_blank' style="height:704px;width:1216px;">
    <div class="top"><i></i>桓台县大数据统计分析平台</div>
    <div class="bottom">
