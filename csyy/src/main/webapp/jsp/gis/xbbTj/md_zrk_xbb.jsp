      ...
      <div  class="map-dialog-ex">       
        ...
        <div class="portlet map-app-set">
          <div class="portlet-title">
            <div class="caption">各行政区划总人口性别比</div>
          </div>
...
$("#zrkGrid").datagrid({ 
					   ...
					   {field:'value1',title:'男性'},
					   {field:'value2',title:'女性'},
		               {field:'value3',title:'男女比例'}
		               ]]
              });
var option = {
    title: {
    ...
    series: [
        {
            ...
            data:[dataList[0].value3, dataList[1].value3, dataList[2].value3, dataList[3].value3, dataList[4].value3, dataList[5].value3, dataList[6].value3, dataList[7].value3, dataList[8].value3]
