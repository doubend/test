...
<body>
		...
		<div class="easyui-layout" data-options="fit:true">
			...
			<div data-options="region:'center',title:'人员列表'">
				<table id="datagrid" data-options="
					   ...
					   pagination:true,pageList:[15, 30, 50],pageSize:15,
						...
						<tr>
							...
							<th data-options="field:'type',width:50,
								formatter:function(value,row,index) {
				 					...
				 					if(value==2) return '政府部门';
				 					if(value==4) return '人员';
				 					if(value==3) return '企业部门';
				 					if(value==0) return '政府机构';
				 					return '';
				 				}">类型</th>
						</tr>
					</thead>
 ...
 <script data-main="${contextPath}/js/system/organ-select" src="${contextPath}/js/assets/require.js"></script>
