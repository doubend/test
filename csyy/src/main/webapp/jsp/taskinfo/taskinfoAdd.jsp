...
<div class="newwrapper" style="background-color: #FFF">
    ...
    <div class="container-fluid fluid">
        <div class="row png-10 line-hei-2">
            ...
            <div class="col-xs-10 text-left"><input type="text" class="form-control easyui-validatebox" name="name" data-options="required:true" /></div>
        </div>
        <div class="row png-10 line-hei-2">
            <div class="col-xs-2 text-right"><em class="require_key">*</em><label>任务类</label>：</div>
            <div class="col-xs-10 text-left">
                <input type="text" class="form-control easyui-validatebox" name="taskBeanId" data-options="required:true" />
            </div>
        </div>
        <div class="row png-10 line-hei-2">
        ...
        <div class="row png-10 line-hei-2">
            ...
            <div class="col-xs-8 text-left">
                <input name="cron" data-options="required:true,validType:'fn[taskinfo.taskinfoAdd.checkCron]',invalidMessage:'cron表达式不合法！'" type="text" maxlength="50"  class="easyui-validatebox form-control validatebox-text" id="cronValue"  />
            </div>
            <div class="col-xs-2 text-left">
                <button type="button" onclick="taskinfo.taskinfoAdd.setCron();" class="btn btn-primary btn-xs mgl-20">精确设置</button>
            </div>
        </div>
...
<!-- 控制按钮 -->
   <div style="position:fixed;bottom:6px;text-align: center;width: 100%">
       <a onclick="taskinfo.taskinfoAdd.save()" href="javascript:;" class="btn green" style="margin: 0px 10px"> 保 存</a>
       <a id="exchangeitems_config_cancel" href="javascript:;" class="btn default mgr-10" style="margin: 0px 10px"> 取 消 </a>
   </div>
<script data-main="${contextPath}/js/taskinfo/taskinfoAdd" src="${contextPath}/js/assets/require.js"></script>
</body>
</html>
